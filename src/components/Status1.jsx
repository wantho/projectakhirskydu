            ...
            <div className="">
                ...
                <div className="box3">
                        ...
                        <div className="box5">
                            ...
                            <p className="paragraf4">Kayanya gampang deh.. cek dulu di youtube</p>
                        </div>
                        <img id="r" src={Titik} />
                        <img id="s" src={Edit}  /> <span id="u">Ubah Komentar</span>
                        <img id="t" src={Trash} /> <span id="v">Hapus Komentar</span>
                        <img id="w" src={User5} />
                        <div className="box6">
